...
language_texts = {
    'ru': {
        ...
        'question_2': "Вопрос 2: Бывают ли у вас кожные высыпания (акне, экзема), неприятный запах изо рта или проблемы с обменом веществ?\n\nA: Часто — моя кожа и тело сильно реагируют на изменения питания.\nB: Иногда — бывают вспышки, но не критично.\nC: Редко или вообще не бывает.",
        'question_3': "Вопрос 3: Как вы оцениваете состояние своей печени? (например, ощущение тяжести, употребление жирной пищи или алкоголя)\n\nA: Часто — употребляю жирную пищу или алкоголь, есть дискомфорт.\nB: Иногда — злоупотребляю, но особых проблем не чувствую.\nC: Моя печень в полном порядке.",
    ...
    'en': {
        ...
        'question_2': "Question 2: Do you have skin rashes (acne, eczema), bad breath, or metabolic problems?\n\nA: Often — my skin and body react strongly to dietary changes.\nB: Sometimes — there are outbreaks, but not critical.\nC: Rarely or never.",
        'question_3': "Question 3: How do you assess the condition of your liver? (e.g., feeling of heaviness, consumption of fatty foods or alcohol)\n\nA: Often — I consume fatty foods or alcohol, there is discomfort.\nB: Sometimes — I overindulge, but I don't feel any particular problems.\nC: My liver is in perfect condition.",
